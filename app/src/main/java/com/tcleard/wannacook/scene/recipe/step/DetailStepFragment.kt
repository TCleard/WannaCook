...
import kotlinx.android.synthetic.main.fragment_detail_step.*
import javax.inject.Inject

class DetailStepFragment : ADetailRecipeFragment<DetailStepPresenter>(), DetailStepPresenter.StepView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        DaggerDetailStepComponent.builder()
                .appComponent(appComponent)
                .detailStepModule(DetailStepModule())
                .build()
                .inject(this)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? =
            inflater.inflate(R.layout.fragment_detail_step, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        detailStepList.layoutManager = LinearLayoutManager(requireContext())
        detailStepList.adapter = adapter
